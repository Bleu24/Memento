...
export function displayTasks(title, tasks) {
...
export function displayCompleteTasks(title, tasks) {
    const tasksDiv = document.createElement("div");
    const header = document.createElement('header');
    const heading = document.createElement("h2");
    const taskCounter = document.createElement("span");
    ...
    header.className = "completeTaskHeader";
    tasksDiv.className = "completeTasksContainer";
    heading.className = "completeTasksContainer__heading";
    taskCounter.className = "completeTasksContainer__taskCounter";
    taskList.className = "completeTasksContainer__taskList";
